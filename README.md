[text](TEMPLATE_BACKEND_NODEJS/.env-test) [text](TEMPLATE_BACKEND_NODEJS/.eslintrc.json) [text](TEMPLATE_BACKEND_NODEJS/.gitignore)[text](<../../../broker_backend 2/broker_backend/field_valodator>)# TEMPLATE_BACKEND_NODE
